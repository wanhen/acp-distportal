  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="card">
        ...
        <h5 class="card-title text-white"> FILE STOK UPLOAD </h5>
        ...
        <div class="row">
          ...
          <form action="{{ route('upload_stok') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <input type="hidden" name="report_type" id="report_type" value="STOK">
                <div class="form-group">
