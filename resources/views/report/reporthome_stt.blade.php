...
@section('page_title', 'Admin Report - STT')
    ...
    <div class="row">
      ...
      <div class="card">
        <div class="card-header bg-green">
            <h5 class="card-title text-white"> Laporan Admin - STT Distributor</h5>
        </div>
        <div class="card-body">
...
@section('page_js')
    <script type="text/javascript" src="{{ url('/assets/js/reporthome_stt.js') }}"></script>
@endsection